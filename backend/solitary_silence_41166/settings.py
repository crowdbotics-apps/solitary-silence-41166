"""
Django settings for solitary_silence_41166 project.
...
ROOT_URLCONF = 'solitary_silence_41166.urls'
...
WSGI_APPLICATION = 'solitary_silence_41166.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_silence_41166 API",
    "DESCRIPTION": "API documentation for solitary_silence_41166 App",
    "VERSION": "v1",
}
